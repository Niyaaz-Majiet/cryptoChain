...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when chain DOES start with the genesis block and has multiple blocks', () => {
            beforeEach(() => {
                blockchain.addBlock({ data: 'bears' });
                blockchain.addBlock({ data: 'sonny' });
                blockchain.addBlock({ data: 'tiger' });
            });
            describe('and a `lastHash` refeerence has changed', () => {
                it('returns false', () => {
    ...
    describe('replaceChain()', () => {
        ...
        describe('and the `validTransactions` flag is true',()=>{
           it('call validTransactionData()',()=>{
               const validTransactionDataMock = jest.fn();

               blockchain.validTransactionData = validTransactionDataMock;

              newChain.addBlock({data:'frodo'});
    ...
    describe('validTransactionData()', () => {
        ...
        describe('and  the transactions data has multiple rewards', () => {
