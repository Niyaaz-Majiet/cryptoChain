    ...
    describe('validTransaction()', () => {
        ...
        describe('when the transaction is invalid', () => {
            describe('and a transaction outputMap is invalid', () => {
                it('returns false and logs erro', () => {
            ...
            describe('and the transaction input signature is invalid', () => {
                it('returns false and logs an error', () => {
                    transaction.input.signature = new Wallet().sign('data-test-data')
                    expect(Transaction.validTransaction(transaction)).toBe(false);
                    expect(errMock).toHaveBeenCalled();
                });
            });
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            it('maintains a total output that matches the input amount', () => {
                let overallOutputAmountTotal = Object.values(transaction.outputMap)
                    .reduce((total, outputAmount) => total + outputAmount);

                expect(overallOutputAmountTotal).toEqual(transaction.input.amount);
            });
            ...
            describe('and another update for the same recipient', () => {
                ...
                it('subtracts the amount from the original output amount',()=>{
                   expect(transaction.outputMap[senderWallet.publicKey])
